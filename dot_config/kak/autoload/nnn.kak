## nnn integration for Kakoune via tmux splits

define-command -hidden -params 2 nnn-launch-picker %{
...
define-command nnn-files -docstring 'browse files with nnn; Enter opens, q quits' %{
    nnn-launch-picker kak-picker-nnn kak-nnn-files
}
