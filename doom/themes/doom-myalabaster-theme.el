...
(def-doom-theme doom-myalabaster
  ...
  (((font-lock-comment-face &override) :background "#FFFABC")
   ((font-lock-doc-face &override) :background  "#FFFABC")
   ((clojure-keyword-face &override) :foreground blue)
   ;; (highlight-numbers-number :background  "#DBF1FF")
   ;; ((font-lock-string-face &override) :background  "#F1FADF")
